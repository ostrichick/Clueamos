...
2. 목록에서 `(본인의 GitHub 계정)/Clueamos` 저장소를 찾은 후 **[Import]** 버튼을 누릅니다.
...
3. 약 1분 정도 빌드가 진행된 후, 축하 화면과 함께 웹 주소가 생성됩니다!

---

## 📱 아내와 함께 접속하여 플레이하기
* 발급된 주소를 아내분의 스마트폰, 태블릿, 혹은 노트북 메신저로 전송하세요.
...
## ⚙️ 팀/신규 기여자 참고사항
* Vercel 계정이 여러 개인 경우, 저장소를 다른 계정으로 이전하면 이전 프로젝트가 중단될 수 있으니 배포 주소 관리에 주의하세요.
* 팀 공동 배포가 필요하면 Vercel 팀(Team) 기능을 사용해 배포 소유권을 공유할 수 있습니다.